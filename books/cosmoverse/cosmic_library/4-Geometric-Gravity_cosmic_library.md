...
<!-- نقل قول -->
<div style="background: linear-gradient(135deg, #1a2e4f 0%, #2c3e6e 100%); border-radius: 16px; padding: 30px; margin: 30px 0; text-align: center; border: 1px solid #4a6fa5;">
    <span style="font-size: 2.5rem; color: white;">🌀</span>
    <span style="font-size: 2.5rem;">✨</span>
    <p style="font-size: 1.3rem; color: white; font-style: italic; margin: 15px 0;">
        "مهم این است که هرگز از پرسیدن سؤال دست نکشیم. کنجکاوی دلیل وجودی ماست."
    </p>
    <p style="color: #a0c0e0; font-weight: bold;">- آلبرت اینشتین، فیزیکدان و خالق نظریه نسبیت</p>
</div>
