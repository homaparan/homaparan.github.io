...
<!-- اینفوگرافیک ترکیب جهان - فصل ۵ (ماده تاریک) -->
<div style="background: linear-gradient(135deg, #0f0f1f 0%, #1a1a2e 100%); border-radius: 20px; padding: 30px; margin: 30px 0; text-align: center; color: white; border: 1px solid #4a4a6a;">
    <h3 style="color: white; font-size: 1.8rem; margin-bottom: 20px;">🌑 ترکیب جهان: ماده تاریک</h3>
    
    <!-- نمودار اصلی -->
    <div style="display: flex; justify-content: center; align-items: center; gap: 40px; flex-wrap: wrap; margin-bottom: 30px;">
        <!-- ماده معمولی (۵٪) -->
        <div style="text-align: center;">
            <div style="width: 100px; height: 100px; border-radius: 50%; background: #5a7ea0; margin: 0 auto; display: flex; align-items: center; justify-content: center; font-size: 2rem; font-weight: bold; color: white; box-shadow: 0 8px 15px rgba(0,0,0,0.3);">۵٪</div>
            <p style="margin-top: 15px; font-weight: bold; color: #a0a0c0;">ماده معمولی</p>
        </div>
        
        <!-- ماده تاریک (۲۷٪) - برجسته‌تر -->
        <div style="text-align: center;">
            <div style="width: 140px; height: 140px; border-radius: 50%; background: linear-gradient(135deg, #4a4a6a 0%, #2c2c44 100%); margin: 0 auto; display: flex; align-items: center; justify-content: center; font-size: 2.5rem; font-weight: bold; color: white; border: 3px solid #a0a0ff; box-shadow: 0 0 25px #6a6aff;">۲۷٪</div>
            <p style="margin-top: 15px; font-weight: bold; color: #d0d0ff;">🌟 ماده تاریک</p>
        </div>
        
        <!-- انرژی تاریک (۶۸٪) -->
        <div style="text-align: center;">
            <div style="width: 100px; height: 100px; border-radius: 50%; background: #2c3e5c; margin: 0 auto; display: flex; align-items: center; justify-content: center; font-size: 2rem; font-weight: bold; color: white; box-shadow: 0 8px 15px rgba(0,0,0,0.3);">۶۸٪</div>
            <p style="margin-top: 15px; font-weight: bold; color: #a0a0c0;">انرژی تاریک</p>
        </div>
    </div>
    
    <!-- ریزترکیبات ماده معمولی -->
    <div style="background: rgba(255,255,255,0.05); border-radius: 16px; padding: 20px; margin-top: 20px;">
        <p style="color: #e0e0ff; font-size: 1rem; margin-bottom: 15px;">🔬 ماده معمولی (۵٪) شامل:</p>
        <div style="display: flex; justify-content: center; gap: 40px; flex-wrap: wrap;">
            <div>
                <span style="display: inline-block; width: 12px; height: 12px; border-radius: 50%; background: #ffd700; margin-left: 8px;"></span>
                <span>ستاره‌ها (۳۱٪ از ماده معمولی)</span>
            </div>
            <div>
                <span style="display: inline-block; width: 12px; height: 12px; border-radius: 50%; background: #ffa500; margin-left: 8px;"></span>
                <span>گاز و غبار (۶۹٪ از ماده معمولی)</span>
            </div>
        </div>
        <div style="margin-top: 10px; color: #a0a0c0; font-size: 0.9rem;">
            * کهکشان‌ها تنها ۲۰٪ از ماده معمولی را تشکیل می‌دهند
        </div>
    </div>
    
    <!-- توضیح تکمیلی -->
    <div style="margin-top: 25px; padding: 15px; background: rgba(74, 74, 106, 0.3); border-radius: 12px; font-size: 0.95rem; color: #d0d0ff;">
        <span style="font-weight: bold;">🌑 واقعیت شگفت‌انگیز:</span> ماده تاریک ۵ برابر ماده معمولی در جهان است! این ماده نامرئی تنها از طریق اثر گرانشی خود قابل شناسایی است.
    </div>
</div>
...
<div class="content-section">
    <div class="section-title">
        🖼️ تصاویر نجومی <span>۲ تصویر</span>
    </div>
...
<div class="kitchen-card">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 30px; align-items: center; justify-content: center; margin: 30px 0;">
        ...
        <div style="flex: 1; min-width: 250px;">
            <img src="../../../img/cosmoverse/gravitational-lensing.jpg" alt=" عدسی گرانشی" style="width: 100%; max-width: 350px; border-radius: 16px; box-shadow: 0 8px 20px rgba(0,0,0,0.2); border: 3px solid white;" onerror="this.src='../../../../img/cosmoverse/gravitational-lensing.jpg'; this.onerror=null;">
            <p style="margin-top: 10px; color: #1a1a2e; font-size: 0.9rem;">
                <strong> عدسی گرانشی</strong><br>
                اعتبار: NASA
            </p>
        </div>
        ...
        <div style="flex: 2; min-width: 250px;">
            <p style="font-size: 1.1rem; line-height: 1.8; color: #1a1a2e;">
                ماده تاریک را نمی‌توان مستقیماً دید، اما با  عدسی گرانشی می‌توانیم حضور آن را تشخیص دهیم. در این فعالیت، با پدیده خمیدگی نور در میدان گرانشی آشنا می‌شوید.
            </p>
