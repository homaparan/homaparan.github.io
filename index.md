...
---
گروه «هماپران دانش» مجموعه‌ای علمی–آموزشی است که با هدف گسترش دانش عمومی و تخصصی در حوزه‌های فیزیک، کیهان‌شناسی و آموزش نوین، فعالیت خود را آغاز کرده است. تمرکز اصلی آن بر تولید محتوای علمی قابل‌فهم برای عموم، ترجمه‌ی منابع تخصصی، و طراحی محصولات آموزشی نوآورانه است.
فعالیت‌های گروه شامل:
۱. تهیه و تولید پادکست‌ها و اپیزودهای علمی-آموزشی صوتی و تصویری با محوریت آموزش مفاهیم فیزیک و کیهان‌شناسی.
۲. ترجمه و بومی‌سازی کتاب‌های علمی تخصصی برای مخاطب فارسی‌زبان.
۳. طراحی و انتشار محتواهای آموزشی دروس دبیرستان، دانشگاه و کنکور.
۴. آموزش و تدریس حضوری و آنلاین.

نخستین دستاورد این مجموعه، در همکاری با انتشارات مبتکران، کتاب ماجراهای کیهان است؛ اثری که امید می‌رود با استقبال گسترده‌ی جامعه‌ی علمی و آموزشی همراه شود.
